...
/**
 * The {@link etaBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author Joe Inkenbrandt - Initial contribution
 */
@NonNullByDefault
public class etaBindingConstants {

    private static final String BINDING_ID = "eta";
    ...
    public static final ThingTypeUID eta_THING = new ThingTypeUID(BINDING_ID, eta);
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(eta_THING);
